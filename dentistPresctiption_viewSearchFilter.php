        ...
        <div style="width: 83%">
            <div class="p-5">
                    ...
                    <!-- <div class="row mb-3">
                        ...
                        <div class="col-md-6 d-flex justify-content-end ">
                            <form action="dentistPresctiption_viewSearch.php" method="get" class="d-flex justify-content-center align-items-center">
                                <input type="text" name="search" id="search" class="form-control mb-0">
                ...
                <?php 
                    ...
                    // $sqlp = "SELECT p.prescriptionId, p.patientId, p.dentistId, p.patientName, p.dateToday, p.date_Submitted, p.dentistName, p.medicine, p.notes, u.patientId, u.gender, u.address FROM prescription p INNER JOIN users u ON p.patientId = u.patientId WHERE dentistId ='$dentistId' AND p.date_Submitted BETWEEN '$from_dateSearch' AND '$to_dateSearch' AND patientName LIKE '%$search%' ORDER BY p.date_Submitted DESC";
                    $sqlp = "SELECT p.prescriptionId, p.patientId, p.dentistId, p.patientName, p.dateToday, p.date_Submitted, p.dentistName, p.medicine, p.notes, u.patientId, u.gender, u.address FROM prescription p INNER JOIN users u ON p.patientId = u.patientId WHERE p.dentistId ='$dentistId' AND p.patientName LIKE '%$search%' AND p.date_Submitted BETWEEN '$from_dateSearch' AND '$to_dateSearch'";
