        ...
        <div style="width: 83%">
            ...
            <div class="card mt-5">
                ...
                <div class="card-body m-5" id="printThis">
                    ...
                    $sqlp = "SELECT p.treatmentId, p.dentistId, p.date_visit, p.service_name, p.teethNo, p.description, p.fees, p.remarks, p.dateTreatment_submitted, u.patientId, u.last_name, u.first_name FROM treatment p INNER JOIN users u ON p.patientId = u.patientId ";
