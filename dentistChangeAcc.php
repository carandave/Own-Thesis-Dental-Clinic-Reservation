...
<head>
    ...
    <title>Dental Clinic | Change Acc </title>
...
<body style="height: 100vh;">
            ...
            <div class="p-5">
                ...
                <form action="" method="post" id="updateCredentials-form" style="margin-bottom: 300px;">
                    <div class="row">
                        ...
                        <input type="text" value="<?php echo $rows['password']?>" name="dentistCurrentPassword" class="d-none">
                        <div class="col-md-6">
    ...
    <script>
        ...
        $(document).ready(function (){
            ...
            e.preventDefault();
            $.ajax({
                url: 'dentistChangeAcc_update.php',
                method: 'post',
