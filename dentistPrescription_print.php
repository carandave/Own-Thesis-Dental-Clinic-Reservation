            ...
            <div class="card mt-5">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        <h5 class="card-title mb-0 mr-3">Print Prescriptions</h5>
                ...
                <div class="card-body m-5" id="printThis">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <h6><?php echo $namePrint;?></h6>
                                    <h6><?php echo $genderPrint;?></h6>
                                    <h6><?php echo $addressPrint;?></h6>
                                </div>                      
                            </div>                   
                        </div>
                    ...
                    <h5 class="mt-5">Medical Prescription</h5>
                    <div class="row ">
                        ...
                        <div class="col-md-6">
                            <h6><?php echo $medicinePrint;?></h6>
                            <h6><?php echo $notesPrint;?></h6> 
                        </div>
                    </div>
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-md-12">
                            ...
                            <h6>Lic No.</h6>
                            <!-- <h6>Ptr No.</h6> -->
                            <!-- Dito na tayo sa pag piprint ng mga data ni patient sa dentistPrescription Prin -->
                        </div>
