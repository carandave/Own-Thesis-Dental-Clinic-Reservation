...
<body style="height: 100vh;">
    ...
    <div class="d-flex" >
        ...
        <div style="width: 83%">
            <div class="p-5">
                <h3 style="border-bottom: 2px solid #002c42">Admin</h3>
                <h6 class="mt-3 mb-3">Admin List</h6>
                            ...
                            <form action="admin_add.php" method="post">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="date" name="admin_birthdate" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="admin_gender" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        ...
                                        <input type="number" name="admin_number" class="form-control" required>
                                    </div>
                                    <div class="col-6">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="password" name="admin_cpassword" class="form-control" required>
                                    </div>
                                </div>
                ...
                <?php 
                    ...
                    $sql = "SELECT * FROM dentist WHERE position='Admin'";
