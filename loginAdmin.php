...
<head>
    ...
    <title>Dental Clinic | Log In Officials</title>
</head>
        ...
        <div class="__row row px-sm-5" style="background-color: #D5DFE7 !important;">
            <div class="__column col-sm-12" style="background-color: #D5DFE7 !important;">
                <div class="container d-flex justify-content-center align-items-center" style="background-color: #D5DFE7 !important;">
                    ...
                    <h1 class="create-acc" style="background-color: #D5DFE7 !important;">Officials Sign in</h1>
                        ...
                        <p class="text-center mt-0" style="background-color: #D5DFE7 !important;">Login for Patient? <a href="login.php" id="signup-btn">Click This</a></p>
                    </form>
                </div>
            </div>
        </div>
            ...
            $("#login-btn").click(function(e){ // Kapag na-iclick ang register button gagawin nya yung mga nasa loob ng function
                if(document.getElementById("login-form").checkValidity()){ // Kapag nag true ito or kapag walang nakitang error gagawin nya yung mga nasa loob
                    ...
                    $.ajax({ // Makikipag communicate tayo sa server side 
                        ...
                        data: $("#login-form").serialize() + "&action=loginAdmin", // Eto ang mga input data galing sa form naibabato natin sa server
                        success: function(response){ // Eto ang response na galing sa server papunta sa Client server

                            if(response === "Dentist"){                          

                                
                                console.log("This is true talga sa Dentist");

                                
                                Swal.fire({
                                    position: 'center',
                                    icon: 'success',
                                    title: 'Successfully Log in as a Dentist',
                                    showConfirmButton: false,
                                    timer: 1300  
                                }).then(function(){
                                    window.location = "dashDentist.php";
                                })
                            } 
                            ...
                            Swal.fire({
                                position: 'center',
                                icon: 'success',
                                title: 'Successfully Log in as a Admin',
                                showConfirmButton: false,
                                timer: 1300  
                            }).then(function(){
                            ...
                            if(response === "Staff"){                          
                                ...
                                Swal.fire({
                                    position: 'center',
                                    icon: 'success',
                                    title: 'Successfully Log in as a Staff',
                                    showConfirmButton: false,
                                    timer: 1300  
                                }).then(function(){
