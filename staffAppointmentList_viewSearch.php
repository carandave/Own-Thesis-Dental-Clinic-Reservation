    ...
    <div class="d-flex" >
        ...
        <div style="width: 83%">
            <div class="p-5">
                ...
                <table class="table table-striped table-hover table-bordered" style="margin-bottom: 280px;">
