        ...
        <div style="width: 83%">
            <div class="p-5">
                ...
                <?php 
                    ...
                    // $sql = "for Dentist";
                    $sql = "SELECT a.reqId, a.dentistId, a.date_submitted, a.appointment_date, a.concerned, a.appointment_time, a.status, a.q1, a.q2, a.q3, a.q4, a.q5, a.q6, a.q7, a.q8, a.q9, a.q10, a.q11, a.q12, a.q13, d.dentistId, d.fullname, u.patientId, u.last_name, u.first_name, u.email FROM request_appointment a INNER JOIN dentist d ON a.dentistId = d.dentistId INNER JOIN users u ON a.patientId = u.patientId WHERE a.dentistId = '$dentistId' AND a.status = '$search' ORDER BY reqId DESC";
                ...
                <table class="table table-hover table-striped table-bordered" style="margin-bottom: 480px;">
