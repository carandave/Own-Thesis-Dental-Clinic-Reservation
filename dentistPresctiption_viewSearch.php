        ...
        <div style="width: 83%">
            <div class="p-5">
                ...
                <?php 
                    ...
                    $sqlp = "SELECT p.prescriptionId, p.patientId, p.dentistId, p.patientName, p.dateToday, p.dentistName, p.medicine, p.notes, u.patientId, u.gender, u.address FROM prescription p INNER JOIN users u ON p.patientId = u.patientId WHERE dentistId ='$dentistId' AND patientName LIKE '%$search%'";
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php echo date("l, F j Y", strtotime($rowp['dateToday']));?>
                            </td>
