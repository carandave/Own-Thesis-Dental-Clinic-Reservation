...
<head>
    ...
    <title>Dental Clinic | Prescription Reports</title>
...
<body style="height: 100vh;">
    ...
    <div class="d-flex" >
        ...
        <div style="width: 83%">
            <div class="p-5">
                <h3 style="border-bottom: 2px solid #002c42">Prescription Reports</h3>
                <h6 class="mt-3 mb-3">Prescription List</h6>

                
                <form action="adminPrescriptionReports_print.php" method="POST">
                ...
                <form action="adminPrescriptionReports_filter.php" method="get">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="" class="font-weight-bold">From Date Prescription</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="" class="font-weight-bold">To Date Prescription</label>
                ...
                <?php 
                    ...
                    $sqlp = "SELECT * FROM prescription ORDER BY date_Submitted DESC";
                ...
                <table class="table table-hover table-striped table-bordered" style="margin-bottom: 300px;">
                    <thead style="background-color: #002c42 !important; color: white; text-align: left">
                        ...
                        <th scope="col">Date Submitted Prescription</th>
