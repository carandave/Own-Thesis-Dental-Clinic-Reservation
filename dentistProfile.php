...
<body style="height: 100vh;">
    ...
    <div class="d-flex" >
        ...
        <div style="width: 83%">
            <div class="p-5">
                <h3 style="border-bottom: 2px solid #002c42">Profile </h3>
                ...
                <form action="" method="post" id="updateProfile-form" style="margin-bottom: 300px;">
                    <div class="row">
                        <input type="text" value="<?php echo $rows['dentistId']?>" name="dentistId" class="d-none">
                        <div class="col-md-6">
                            <label for="">Full Name</label>
                            <input type="text" value="<?php echo $rows['fullname'];?>" name="fullname" class="form-control">
                        </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <input type="date" value="<?php echo $rows['birthdate'];?>" name="birthdate" class="form-control">
                        </div>
                ...
                success: function(response){
                    ...
                    if(response == "TrueProfile"){
                        ...
                        Swal.fire({
                            ...
                            window.location = "dentistProfile.php";
