        ...
        <div class="modal fade" id="editmodal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <form action="dentistAppointmentList_update.php" method="POST">
                        <div>
                        ...
                        <div class="row d-none">
                            <div class="col-12">
                                <label for="">Dentist Id <span>*</span></label>
        ...
        <div style="width: 83%">
            <div class="p-5">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <form action="dentistAppointmentList_viewSearch.php" method="get" class="d-flex justify-content-center align-items-center">
                ...
                <?php 
                    ...
                    $sql = "SELECT a.reqId, a.date_submitted, a.appointment_date, a.concerned, a.appointment_time, a.status, a.q1, a.q2, a.q3, a.q4, a.q5, a.q6, a.q7, a.q8, a.q9, a.q10, a.q11, a.q12, a.q13, d.dentistId, d.fullname, u.patientId, u.last_name, u.first_name, u.email FROM request_appointment a INNER JOIN dentist d ON a.dentistId = d.dentistId INNER JOIN users u ON a.patientId = u.patientId WHERE d.dentistId = '$dentistId' AND a.status != 'Treated' ORDER BY reqId DESC";
                ...
                <table class="table table-hover table-responsive table-striped table-bordered" style="margin-bottom: 280px;">
                    <thead style="background-color: #002c42 !important; color: white; text-align: left">
                        ...
                        <th class="d-none" scope="col">Dentist</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-none"><?php echo $row['fullname']; ?></td>
