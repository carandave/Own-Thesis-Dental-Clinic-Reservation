...
<head>
    ...
    <title>Dental Clinic | Query Message</title>
...
<body style="height: 100vh;">
    ...
    <div class="d-flex" >
        ...
        <div style="width: 83%">
            <div class="p-5">
                <h3 style="border-bottom: 2px solid #002c42">Query Messages </h3>
                <h6 class="mt-3 mb-3">Query Message List</h6>

                    
                
                <?php 

                    $sqlp = "SELECT * FROM querymessages";
